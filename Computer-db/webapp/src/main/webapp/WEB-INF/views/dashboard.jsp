			...
			<table class="table table-striped table-bordered">
				...
				<thead>
					<tr>
						...
						<th><a
							href="http://localhost:8080/webapp/dashboard?page=${currentplace}&recordsPerPage=${recordsPerPage}&Order=computer&currentplace=${currentplace}">
								Computer name &#8595; </a></th>
						...
						<th><a
							href="http://localhost:8080/webapp/dashboard?page=${currentplace}&recordsPerPage=${recordsPerPage}&Order=company&currentplace=${currentplace}">
								Company </a></th>
		...
		<div class="container text-center">
			<ul class="pagination">
				<c:if test="${min_button >1}">
					<li>
					<li><a
						href="http://localhost:8080/webapp/dashboard?page=${currentplace-1}&recordsPerPage=${recordsPerPage}&Order=${Order}&currentplace=${currentplace-1}"
				...
				<c:forEach var="i" end="${max_button}" begin="${min_button}"
					varStatus="loop">
					<li><a
						href="http://localhost:8080/webapp/dashboard?page=${i}&recordsPerPage=${recordsPerPage}&Order=${Order}&currentplace=${i}">${i}
					</a></li>
				</c:forEach>
