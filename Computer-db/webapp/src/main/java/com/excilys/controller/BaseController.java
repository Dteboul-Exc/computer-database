...
public class BaseController {
	...
	public String postHandlerAdd(@RequestParam(required = false, value = "Add") String Add,
			@RequestParam(required = false, value = "selection") String selection,
	...
	public ModelAndView dashboard(@RequestParam(required = false, value = "page") Integer page,
			@RequestParam(required = false, value = "recordsPerPage") Integer recordsPerPage,
			@RequestParam(required = false, value = "currentplace") Integer currentplace,
	...
	private void setParameters(String Order, int recordsPerPage, int max_button, int min_button, List<ComputerDTO> list,
			int currentplace, int computer, ModelAndView model) {
		model.addObject("Order", Order).addObject("recordsPerPage", recordsPerPage).addObject("max_button", max_button)
				.addObject("min_button", min_button).addObject("Computer_list", list)
				.addObject("currentplace", currentplace).addObject("computer", Integer.toString(computer));
	}
