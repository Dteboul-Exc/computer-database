...
public class ServiceComputer {
	...
	public int deleteSpecificComputer(int id)  {
		BasicConfigurator.configure();
		lOG.debug("DeleteSpecificComputer start using computer id : " + id);
		int result;
		try {
	...
	public int addComputer(ComputerDTO computer)  {
		...
		try {
			...
			int result = main.java.exc.persistence.DAOComputer.addComputer(tname, tintroduced, tdiscontinued,
					Integer.parseInt(computer.getCompany().getId()));
			return result;
	...
	public int updateComputer(ComputerDTO computer) throws NumberFormatException {
		...
		try {
			...
			lOG.debug("id of company is :" + computer.getCompany().getId());
			int result = DAOComputer.updateComputer(tname, tintroduced, tdiscontinued,
					Long.parseLong(computer.getCompany().getId()), Integer.parseInt(computer.getId()));
			return result;
