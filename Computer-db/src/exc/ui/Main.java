...
public class Main {
	...
	private static void Computer_Add() throws ParseException
	{
		...
		while (check) {
			...
			case Introduced:
				sta = Computermapper.Main;
				System.out.println("Enter the introduced (format YYYY-MM-DD hh:mm:ss)");
				String introduced = reader.next();
				computer.setIntroduced(introduced);
				break;
			case Discontinued:
				sta = Computermapper.Main;
				System.out.println("Enter the discontinued (format YYYY-MM-DD hh:mm:ss)");
