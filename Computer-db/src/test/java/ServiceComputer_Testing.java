...
public class ServiceComputer_Testing {
	...
	public static void init() {
		list.add(Computer.Builder.newInstance().setId(12).setName("Jole").setCompany(new Company(14, "Kalo")).build());
		list.add(Computer.Builder.newInstance().setId(54).setName("Jole").setCompany(new Company(14, "Kalo")).build());
	...
	public void testfindID() throws ClassNotFoundException, SQLException, ParseException {
		Computer c = Computer.Builder.newInstance().setId(45).setName("Jole")
				.setDiscontinued(LocalDate.of(2014, Month.JANUARY, 1))
				.setIntroduced(LocalDate.of(2013, Month.JANUARY, 1)).setCompany(new Company(14, "Kalo")).build();
	...
	/*
	 * @Test// public void UpdateComputerTesting() throws ClassNotFoundException,
	 * SQLException, ParseException { Computer c = Computer.Builder
	 * .newInstance().setId(45).setName("Jole") .setDiscontinued(LocalDate.of(2014,
	 * Month.JANUARY, 1)) .setIntroduced(LocalDate.of(2013, Month.JANUARY, 1))
	 * .setCompany(new Company(14,"Kalo")) .build(); Optional<Computer> tested =
	 * Optional.of(c);
	 * //Mockito.when(mockDAO.getSpecificComputer(0)).thenReturn(tested);
	 * Mockito.when(mockDAO.updateComputer("Jole", LocalDate.of(2013, Month.JANUARY,
	 * 1), LocalDate.of(2014, Month.JANUARY, 1), (long)14, 45)).thenReturn(1);
	 * assertEquals(1,this.service.deleteSpecificComputer(45));
	 * 
	 * }
	 */
