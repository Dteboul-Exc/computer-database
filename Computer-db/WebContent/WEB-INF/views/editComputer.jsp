...
<body>
	<header class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="alert alert-danger" id="error">Indicates a dangerous
			or potentially negative action.</div>
	</header>
	<section id="main">
		<div class="container">
			<div class="row">
					...
					<form action="dashboard" method="POST">
						...
						<fieldset>
							<div class="form-group">
								<label for="computerName">Computer name</label> <input
									...
									value=<c:out value = "${computerName}"/>> <input
						...
						<div class="actions pull-right">
							<input type="submit" value="Edit" name="Edit"
								onclick="Validate()" class="btn btn-primary"> or <a
